...
grid_b = Def.Quad{ InitCommand=cmd(stretchto,SCREEN_LEFT,SCREEN_TOP,SCREEN_RIGHT,SCREEN_TOP+30;diffuse,color(theme_dark_color);diffusebottomedge,color("0.2,0.1,0,1")); };
grid_c = Def.Quad{ InitCommand=cmd(stretchto,SCREEN_LEFT,SCREEN_BOTTOM-30,SCREEN_RIGHT,SCREEN_BOTTOM;diffuse,color(theme_dark_color);diffusebottomedge,color("0.2,0.1,0,1")); };
...
grid_fast_fade_out = Def.Quad{ OnCommand=cmd(stretchto,SCREEN_LEFT,SCREEN_TOP,SCREEN_RIGHT,SCREEN_BOTTOM;diffuse,color("0,0,0,0");sleep,0.1;diffuse,color("0,0,0,0.1");sleep,0.1;diffuse,color("0,0,0,0.2");sleep,0.1;diffuse,color("0,0,0,0.3");sleep,0.1;diffuse,color("0,0,0,0.4");sleep,0.1;diffuse,color("0,0,0,0.5");sleep,0.1;diffuse,color("0,0,0,0.6");sleep,0.1;diffuse,color("0,0,0,0.7");sleep,0.1;diffuse,color("0,0,0,0.8");sleep,0.1;diffuse,color("0,0,0,0.9");sleep,0.1;diffuse,color("0,0,0,1")); };
grid_fast_fade_in = Def.Quad{ OnCommand=cmd(stretchto,SCREEN_LEFT,SCREEN_TOP,SCREEN_RIGHT,SCREEN_BOTTOM;diffuse,color("0,0,0,1");sleep,0.1;diffuse,color("0,0,0,0.9");sleep,0.1;diffuse,color("0,0,0,0.8");sleep,0.1;diffuse,color("0,0,0,0.7");sleep,0.1;diffuse,color("0,0,0,0.6");sleep,0.1;diffuse,color("0,0,0,0.5");sleep,0.1;diffuse,color("0,0,0,0.4");sleep,0.1;diffuse,color("0,0,0,0.3");sleep,0.1;diffuse,color("0,0,0,0.2");sleep,0.1;diffuse,color("0,0,0,0.1");sleep,0.1;diffuse,color("0,0,0,0")); };
